...
int main() {
    ...
    */
    ...
    double pibPerCapital,pibPerCapital2;
    ...
    pibPerCapital = (double)pib / (double)populacao;
    ...
    pibPerCapital2 = (double)pib2 / (double)populacao2;
    ...
    // variaveis para soma dos atributos numericos
    int somaCarta1,somaCarta2;
    // variavel com o resultado
    char resultado[50];
    printf("***Comparacao das Cartas***\n\n");
    printf("Escolha dois atributo para comparação digitando o seu número (Exceto os nomes dos paises):\n\n");
    ...
    case 3:
        ...
        if (populacao > populacao2){
            ...
            printf("Carta 2 - %s : %lu\n", nome2,populacao2);
            printf("Resultado: Carta 1 (%s) venceu!\n", nome);
        }else if(populacao2> populacao){  // senão se populacao2 for maior de populucao
            printf("Carta 1 - %s : %lu\n", nome,populacao);
            printf("Carta 2 - %s : %lu\n", nome2,populacao2);
            printf("Resultado: Carta 2 (%s) venceu!\n\n", nome2);
    ...
    somaCarta1 = area + populacao + pib + pontosTuristicos + densidadePopulacional;

    printf("Escolha o segundo atributo para comparação (não pode ser igual ao anterior):\n\n");
    printf(" 1 - Nome do país (Exibe apenas os nomes)\n");
    printf(" 2 - Area \n");
    printf(" 3 - Populacao \n");
    printf(" 4 - PIB \n");
    ...
    if (escolha2 == escolha){
        printf("Voce ja escolheu essa opcao, escolha outra...");
        return 1;
    } else{
        switch (escolha2){
            case 1:
    ...
    // soma dos atributos da carta 2
    somaCarta2 = area2 + populacao2 + pib2 + pontosTuristicos2 + densidadePopulacional2;

    printf("===================================================================\n\n");

    printf("Segundo Round...\n");
    printf("Nesse round, a carta vencedora será aquela que a soma de seus atributos for maior...\n\n");

    printf("Carta %s x %s\n\n", nome,nome2);

    strcpy(resultado, (somaCarta1 > somaCarta2) ? "Jogador 1 venceu!" :
                   (somaCarta2 > somaCarta1) ? "Jogador 2 venceu!" : "Empate!");
